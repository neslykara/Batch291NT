...
public class Variables01 {
    public static void main(String[] args) {
        ...
        System.out.println("Total Price1:" + (shirtPrice1 + sockPrice1)); //Total Price1:38.98

        //2.yol:
        float sockPrice2 = 12.99f, shirtPrice2 = 25.99f;
        System.out.println("Total Price2:" + (shirtPrice2 + sockPrice1)); //Total Price2:38.98
        ...
        System.out.println(cellWeight); //2.8E-19 ==>2.8 .arpı 10 üzeri -19 demektir.
        ...
        char firstLetterOfTheName = 'N';
        System.out.println("firstLetterOfTheName : " + firstLetterOfTheName); //firstLetterOfTheName : N
