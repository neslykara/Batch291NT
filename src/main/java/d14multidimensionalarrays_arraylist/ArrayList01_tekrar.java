...
public class ArrayList01_tekrar
{
    public static void main(String[] args)
    {
        ...
        */
        ...
        // ArrayList<Integer> ages = new ArrayList<Integer>(); //Java 6 ve öncesinde bu yazım şekli kullanılıyordu
        ArrayList<Integer> ages = new ArrayList<>(); //Java 7 ve sonrası
        ...
        //List'te araya eleman eklemek için index numarası yazarız.

        ages.add(3,7);
        System.out.println(ages); //[9, 12, 5, 7]

        ages.add(11);
        System.out.println(ages); //[9, 12, 5, 7, 11]
